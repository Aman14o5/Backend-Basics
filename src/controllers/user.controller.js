...
const getUserChannelProfile = asyncHandler(async (req,res) => {
    ...
    //result of aggregate pipeline is an array
        ...
        },
        {
            $lookup: {
                ...
                pipeline:[
                    ...
                    {
                        //this step is to simplify the data sent hence 
                        //at the frontend directly the object will be sent 
                        //not the array hence simplifies it
                        $addFields:{
                            owner:{
                                $first: "$owner"
                            }
